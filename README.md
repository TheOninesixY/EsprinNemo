...
```
data/
├── config.json     # 偏好设置：主题、主题色、应用名颜色、字体、拼写检查、废纸篓保留天数、自动更新开关、托盘图标开关、自定义文件夹、AI 接口配置、当前选中的对话等
...
│       └── scripts/        # state / storage / markdown / ui / theme_color / notes / scratchpad / tray / editor / ai / ai_chats / ai_files / ai_agent / update / render …
